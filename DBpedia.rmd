...
Persistency Measure Result: 
 ...
 Persistency=  `r persistencyMeasure(entityData)`
...
Total no. of class = `r length(unclass)`
No. of persistency=`r nrow(histPer[histPer$Persistency==0,])`
HistPersistencyMeasure= `r HistPersistencyMeasure(histPer)` %
